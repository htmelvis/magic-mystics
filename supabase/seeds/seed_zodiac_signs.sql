...
-- Aries
('Aries', '♈', 'Fire', 'Cardinal', 'Mars', '2000-03-21', '2000-04-19',
...
-- Taurus
('Taurus', '♉', 'Earth', 'Fixed', 'Venus', '2000-04-20', '2000-05-20',
...
-- Gemini
('Gemini', '♊', 'Air', 'Mutable', 'Mercury', '2000-05-21', '2000-06-20',
...
-- Cancer
('Cancer', '♋', 'Water', 'Cardinal', 'Moon', '2000-06-21', '2000-07-22',
...
-- Leo
('Leo', '♌', 'Fire', 'Fixed', 'Sun', '2000-07-23', '2000-08-22',
...
-- Virgo
('Virgo', '♍', 'Earth', 'Mutable', 'Mercury', '2000-08-23', '2000-09-22',
...
-- Libra
('Libra', '♎', 'Air', 'Cardinal', 'Venus', '2000-09-23', '2000-10-22',
...
-- Scorpio
('Scorpio', '♏', 'Water', 'Fixed', 'Pluto', '2000-10-23', '2000-11-21',
...
-- Sagittarius
('Sagittarius', '♐', 'Fire', 'Mutable', 'Jupiter', '2000-11-22', '2000-12-21',
...
-- Capricorn
('Capricorn', '♑', 'Earth', 'Cardinal', 'Saturn', '2000-12-22', '2001-01-19',
...
-- Aquarius
('Aquarius', '♒', 'Air', 'Fixed', 'Uranus', '2001-01-20', '2001-02-18',
...
-- Pisces
('Pisces', '♓', 'Water', 'Mutable', 'Neptune', '2001-02-19', '2001-03-20',
